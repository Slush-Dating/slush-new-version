...
const MediaCard = ({
    ...
    const fullUrl = getAbsoluteMediaUrl(url);
                ...
                <div className="profile-container-new profile-page-enter">
                    ...
                    <header className="profile-hero">
                        ...
                        {currentHeroMedia ? (
                            isCurrentHeroVideo ? (
                                <video
                                    src={getAbsoluteMediaUrl(currentHeroMedia)}
                                            ...
                                            <div className="media-preview-grid">
                                                {[...photos, ...uploadedPhotos].map((photo, index) => (
                                                    <div key={`photo-${index}`} className="media-preview-item">
                                                        <img src={getAbsoluteMediaUrl(photo)} alt="Profile photo" />
                                                        <button
                                            ...
                                            <div className="media-preview-grid">
                                                {[...videos, ...uploadedVideos].map((video, index) => (
                                                    <div key={`video-${index}`} className="media-preview-item">
                                                        <video src={getAbsoluteMediaUrl(video)} />
                                                        <button
                                                            className="remove-media-btn"
                            ...
                            <>
                                ...
                                <section className="section-identity">
                                    <div className="identity-header">
                                        ...
                                        <p className="profession">{user.profession || 'Add your profession'}</p>
                                    </div>
